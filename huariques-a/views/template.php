  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
			...
			<!--========================================
				OFERTAS
				========================================-->
				<?php include "modules/ofertas.php"; ?>
			<!--========================================
				FIN OFERTAS
				========================================-->
			...
			<!--========================================
				OFERTAS
				========================================-->
				<?php include "modules/nuevos.php"; ?>
			<!--========================================
				FIN OFERTAS
				========================================-->
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
							...
							<span class="block">IDAT <a href="#" target="_blank">HUARIQUES</a> <a href="http://owldesarrollo.com/" target="_blank"></a></span>
						</p>
					</div>
				</div>
			</div>
