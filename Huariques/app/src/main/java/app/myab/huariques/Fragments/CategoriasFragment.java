...
import app.myab.huariques.Adapter.CategoriasAdapter;
import app.myab.huariques.Api.Api;
import app.myab.huariques.Api.RequestHandler;
import app.myab.huariques.Model.Categorias;
...
public class CategoriasFragment extends Fragment implements View.OnClickListener{
    ...
    public void updateCategoria(int id){
        ...
        Snackbar.make(getView(), "haz editado correctamente!!!", Snackbar.LENGTH_LONG).show();
    }
